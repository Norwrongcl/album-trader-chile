...
export const defaultRegionCode = 'RM'
...
export function getRegionByCode(code: string) {
  return chileRegions.find((region) => region.code === code) ?? chileRegions.find((region) => region.code === defaultRegionCode) ?? chileRegions[0]
}
